...
public class Province implements Serializable {
	...
	public static ArrayList<Province> getProvinceList() {
		String[] arr = { "--Choose province--", "An Giang", "Ba Ria – Vung Tau", "Bac Lieu", "Bac Giang", "Bac Kan",
				...
				"Ha Giang", "Ha Nam", "Hanoi", "Ha Tinh", "Hai Duong", "Hai Phong", "Hau Giang", "Hoa Binh", "Hung Yen",
				"Khanh Hoa", "Kien Giang", "Kon Tum", "Lai Chau", "Lang Son", "Lao Cai", "Lam Dong", "Long An",
				...
				"Thanh Hoa", "Ho Chi Minh ", "Thua Thien Hue", "Tien Giang", "Tra Vinh", "Tuyen Quang", "Vinh Long",
				"Vinh Phuc", "Yen Bai" };
