	...
	public void actionPerformed(ActionEvent e) {
		...
		if (src.equals("Insert")) {
			...
			try {
				...
				if (this.SMV.studentManagementModel.getChoose().equals("Insert")
						|| this.SMV.studentManagementModel.getChoose().equals("")) {
			...
			int result = JOptionPane.showConfirmDialog(this.SMV, "Delete this student?", "ConFirm",
